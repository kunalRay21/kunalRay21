...
mostly living in the backend, database, and task queue space right now. slowly crawling toward data processing, statistical scripting, and eventual predictive systems.

---

*links, dms, whatever — i don't bite.*
